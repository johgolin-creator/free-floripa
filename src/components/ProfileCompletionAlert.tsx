...
export function ProfileCompletionAlert({ complete, missing, onEdit }: ProfileCompletionAlertProps) {
  if (complete) {
    return (
      <div className="mb-4 flex items-center gap-2 rounded-lg bg-aqua-100 p-3 text-sm font-bold text-white">
        <CheckCircle2 size={18} /> Perfil completo para usar o PONT.
      </div>
    );
  }
