...
export const workers: WorkerProfile[] = [
  ...
  },
  {
    ...
    city: "Florianópolis",
    neighborhood: "Centro",
    functions: ["Segurança", "Operador de caixa", "Recepcionista"],
    functionExperience: [
...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    fullAddress: "Rua Felipe Schmidt, 320, Centro",
    neighborhood: "Centro",
    uniform: "Roupa social preta e sapato fechado",
    requiredExperience: "Controle de acesso, postura profissional e apoio à organização do evento",
    description: "Controle de entrada, orientação do público, apoio à equipe de recepção e atenção à movimentação do espaço.",
    benefits: ["Jantar", "Ajuda de custo"],
    contactAfterConfirmation: true,
    urgent: true,
    candidates: 4,
