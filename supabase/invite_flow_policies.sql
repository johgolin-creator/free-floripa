...
-- PASSO 2 de 2. Só execute isto depois de rodar invite_flow.sql como uma
-- execução separada e ela ter terminado com sucesso (os dois novos valores
-- do enum application_status precisam já estar commitados).

-- ---------------------------------------------------------------------------
-- 1) O trabalhador agora também pode mexer na própria linha quando ela está
...
-- ---------------------------------------------------------------------------
-- 2) Guarda-corpo: a política acima, sozinha, deixaria um trabalhador
